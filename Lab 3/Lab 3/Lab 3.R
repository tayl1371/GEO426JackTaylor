...
plot(world["continents"], reset = FALSE)
...
mi_counties <- st_read("C:/Users/joshu/OneDrive/Documents/Geog 426/Vertalka_Material/Labs/Lab 3/mi_counties/Counties_(v17a).shp")
...
marriages <- read.csv("C:/Users/joshu/OneDrive/Documents/Geog 426/Vertalka_Material/Labs/Lab 3/MI_Mariage_rates_2022.csv")
